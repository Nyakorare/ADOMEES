...
CREATE TABLE documents (
    ...
    status ENUM('pending', 'payment_pending', 'payment_accepted', 'in_progress', 'completed', 'cancelled') DEFAULT 'pending',
...
CREATE TABLE document_workflow (
    ...
    current_stage ENUM('pending', 'sales_review', 'editor_polishing', 'printing_document', 'payment_pending', 'payment_accepted', 'completed') DEFAULT 'pending',
    sales_agent_id INT,
    editor_id INT,
    operator_id INT,
    sales_notes TEXT,
    ...
    payment_status ENUM('pending', 'accepted', 'completed') DEFAULT 'pending',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
